...
export const metadata: Metadata = {
  title: "Travel Blog – Fantasy Travels | Guides & Tips 2026",
  description:
    "Travel guides, tips and articles about Punta Cana, Santo Domingo and the Caribbean. Everything you need to know for your next trip.",
  keywords: "punta cana travel blog, punta cana guide 2026, things to do caribbean, dominican republic travel tips",
};
    ...
    <div>
      ...
      <section className="bg-gray-900 text-white py-20 text-center">
        <div className="max-w-2xl mx-auto px-6">
          <p className="text-primary font-medium text-sm uppercase tracking-wide mb-2">Travel tips</p>
          <h1 className="text-5xl font-semibold mb-4">Travel blog</h1>
          <p className="text-gray-300 text-lg">Guides, tips and experiences to make your Caribbean trip perfect.</p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <Link href={`/blog/${featured.slug}`} className="card-hover block bg-white rounded-3xl overflow-hidden border border-gray-100 mb-12 group md:flex">
          ...
          <div className="p-8 flex flex-col justify-center">
            <p className="text-gray-400 text-sm mb-3">{featured.date} · {featured.readTime} read</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {rest.map((post) => (
            <Link key={post.id} href={`/blog/${post.slug}`} className="card-hover bg-white rounded-3xl overflow-hidden border border-gray-100 block group">
              ...
              <div className="p-5">
                <p className="text-gray-400 text-xs mb-2">{post.date} · {post.readTime} read</p>
