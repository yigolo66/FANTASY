...
export const metadata: Metadata = {
  title: "Destinos – Fantasy Travels",
  description: "Explora los mejores destinos del Caribe: Punta Cana, Santo Domingo y Samaná.",
};
    ...
    <div>
      ...
      <section className="bg-gray-900 text-white py-20 text-center">
        <div className="max-w-2xl mx-auto px-6">
          <p className="text-primary font-medium text-sm uppercase tracking-wide mb-2">Descubre</p>
          <h1 className="text-5xl font-semibold mb-4">Nuestros destinos</h1>
          <p className="text-gray-300 text-lg">República Dominicana tiene mucho más que Punta Cana. Explora cada rincón.</p>
        </div>
      </section>

      {/* Mapa interactivo */}
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-semibold mb-6">Mapa de destinos</h2>
